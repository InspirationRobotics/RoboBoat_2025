...
class OAKD_LR:
    def __init__(self, model_path: str, labelMap: list):
        ...
        if(self._findCamera()):
            ...
            print("[OAK-D LR] ERROR: Did not find Oak-D LR Camera.")
            self.device = None
    ...
    def startCapture(self):
        if not self.device:
            ...
            print("[OAK-D LR] Device running.")

        print("[OAK-D LR] Starting pipeline...")
        self._initPipeline()
        self._setProperties()
        self._linkNN()
        self._linkStereo()
        self.device.startPipeline(self.pipeline)
        print("[OAK-D LR] Pipeline initialized.")
        self._initQueues()
