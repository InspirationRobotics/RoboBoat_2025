#!/usr/bin/env python3
# This code is the default code from Luxonis' website to get the Oak D streams and fps data
# TODO: investigate freezing streams, and crashes when connecting to camera
